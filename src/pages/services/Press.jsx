    ...
    return (
        <div className='mx-auto mt-10 mb-10'>
            <Helmet>
                ...
                <meta
                    name='keywords'
                    content={`${t('services.press.title')}, ${t('header.services')} ${t('services.press.title')}, ${t('header.services')} Indo Teknik`}
                />
            </Helmet>
                    ...
                    <div class='lg:w-[1200px] mx-auto '>
                        ...
                        <div class='flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4 relative'>
                            <div class='bg-gradient-to-bl from-neutral-50 to-blue-100 rounded-lg p-8 text-center md:w-1/3'>
                                <p class='font-bold uppercase'>Marbun Supir</p>
                                <p class='text-md font-light italic text-gray-700'>
                                    Pelayanan ramah, alat servis injektor
                                    moderen dan lengkap, pengerjaan bubutan juga
                                    rapi mantapppp indo teknik
                                </p>
                            ...
                            <div class='bg-gradient-to-bl from-neutral-50 to-blue-100 rounded-lg p-8 text-center md:w-1/3'>
                                <p class='font-bold uppercase'>Bilman Gultom</p>
                                <p class='text-md font-light italic text-gray-700'>
                                    Mau service mesin diesel langsung kesini.
                                    Cepat dan lengkap disini
                                </p>
                                <div class='flex items-center justify-center space-x-2 mt-4'>
                                    <svg
                                        class='text-yellow-500 w-4 h-4'
                            ...
                            <div class='bg-gradient-to-bl from-neutral-50 to-blue-100 rounded-lg p-8 text-center md:w-1/3'>
                                <p class='font-bold uppercase'>Herion Taufik</p>
                                <p class='text-md font-light italic text-gray-700'>
                                    Pekerjaan las bubut dan fabrikasi juga
                                    sangat memuaskan hasilnya dengan harga
                                    bersaing. Pekerjaan service tahan lama
                                    👍👍👍👍👍 One stop service for all diesel
                                    and gasoline system
                                </p>
                                <div class='flex items-center justify-center space-x-2 mt-4'>
                                    <svg

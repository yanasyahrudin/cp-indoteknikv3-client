...
const Fabrication = () => {
    ...
    return (
        <div className='mx-auto mt-10 mb-10'>
            <Helmet>
                <title>
                    {t('services.fabrication.title')} | Indo
                    Teknik
                </title>
                <meta
                    name='description'
                ...
                <meta
                    name='keywords'
                    content={`${t('services.fabrication.title')}, ${t('header.services')} ${t('services.fabrication.title')}, ${t('header.services')} Indo Teknik`}
                />
            </Helmet>
                        ...
                        <div class='flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4 relative'>
                            <div class='bg-gradient-to-bl from-neutral-50 to-blue-100 rounded-lg p-8 text-center md:w-1/3'>
                                ...
                                <p class='text-md font-light italic text-gray-700'>
                                    Terima kasih indo teknik, walaupun saya
                                    punya unit Bosch tidak beli langsung dari
                                    indo teknik, tapi indo teknik dengan sigap
                                    dan ramah membantu penyelesaian masalah unit
                                    BOSCH saya tanpa dikenakan biaya, sukses
                                    selalu indo teknik 😃
                                </p>
                            ...
                            <div class='bg-gradient-to-bl from-neutral-50 to-blue-100 rounded-lg p-8 text-center md:w-1/3'>
                                <p class='font-bold uppercase'>Ratu Gultom</p>
                                <p class='text-md font-light italic text-gray-700'>
                                    Tempat service pump dan injector terlengkap
                                    di Pekanbaru.. Pertahankan,,👍👍👍
                                </p>
                                <div class='flex items-center justify-center space-x-2 mt-4'>
                                    <svg
                                        class='text-yellow-500 w-4 h-4'
                            ...
                            <div class='bg-gradient-to-bl from-neutral-50 to-blue-100 rounded-lg p-8 text-center md:w-1/3'>
                                <p class='font-bold uppercase'>Jesiska</p>
                                <p class='text-md font-light italic text-gray-700'>
                                    Indoteknik good job Jual sparepart
                                    terlengkap Kualitas ok Harga terjangkau
                                    Barang2 ORI Yg mau cari sparepart langsung
                                    ke indoteknik aja
                                </p>
                                <div class='flex items-center justify-center space-x-2 mt-4'>
                                    <svg

    ...
    return (
        <div className='mx-auto mt-10 mb-10'>
            <Helmet>
                ...
                <meta
                    name='keywords'
                    content={`${t('services.welding.title')}, ${t('header.services')} ${t('services.welding.title')}, ${t('header.services')} Indo Teknik`}
                />
            </Helmet>
                                ...
                                <p className='mt-2 text-md text-gray-800 text-justify'>
                                    ...
                                    <ul className='list-disc list-inside mt-2 text-gray-700'>
                                        <li className='flex items-start'>
                                            ...
                                            {t(
                                                'services.welding.services.build',
                                            )}
                                        </li>
                                        <li className='flex items-start'>
                                            <IoIosSettings className='mr-2 text-blue-900 w-5 h-5' />
                                        ...
                                        <li className='flex items-start'>
                                            <IoIosSettings className='mr-2 text-blue-900 w-5 h-5' />
                                            {t(
                                                'services.welding.services.repair',
                                            )}
                                        </li>
                                    </ul>

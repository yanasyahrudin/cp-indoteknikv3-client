    ...
    return (
        <div className='mx-auto mt-10 mb-10'>
            <Helmet>
                ...
                <meta
                    name='keywords'
                    content={`${t('services.fuelInjectionPump.title')}, ${t('header.services')} ${t('services.fuelInjectionPump.title')}, ${t('header.services')} Indo Teknik`}
                />
            </Helmet>
            <div>
                    ...
                    <div class='lg:w-[1200px] mx-auto '>
                        ...
                        <div class='flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4 relative'>
                            <div class='bg-gradient-to-bl from-neutral-50 to-blue-100 rounded-lg p-8 text-center md:w-1/3'>
                                <p class='font-bold uppercase'>Supian Supian</p>
                                <p class='text-md font-light italic text-gray-700'>
                                    Pelayanan nya bagus dan cepat, sudah
                                    berlangganan sudah 20 ahun lebih, tempat nya
                                    nyaman dan bersih. Kerjanya cepat, awet
                                    tahan lama, harga super ramah. Spare part
                                    lengkap. Pertahankan ya. Rekomen Indo teknik
                                    👍👍
                                </p>
                            ...
                            <div class='bg-gradient-to-bl from-neutral-50 to-blue-100 rounded-lg p-8 text-center md:w-1/3'>
                                <p class='font-bold uppercase'>kasmin aja</p>
                                <p class='text-md font-light italic text-gray-700'>
                                    Service dan cari sparepart langganan kami
                                    nih. Pelayanan juga ok. Indo teknik yesss
                                </p>
                                <div class='flex items-center justify-center space-x-2 mt-4'>
                                    <svg
                                        class='text-yellow-500 w-4 h-4'
                            ...
                            <div class='bg-gradient-to-bl from-neutral-50 to-blue-100 rounded-lg p-8 text-center md:w-1/3'>
                                <p class='font-bold uppercase'>Jumino Jimy</p>
                                <p class='text-md font-light italic text-gray-700'>
                                    Sangat memuaskan. Sudah menjadi langganan
                                    tempat service injection pump dan injector
                                    kita selalu. Pertahankan..
                                </p>
                                <div class='flex items-center justify-center space-x-2 mt-4'>
                                    <svg
                                        class='text-yellow-500 w-4 h-4'

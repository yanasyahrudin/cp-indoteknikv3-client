...
import categories from '../../../data/wiperCategory'; // Update to the appropriate category data if needed
...
const categoryDetails = {
    ...
    description: descriptionDetailCategory,   imageUrl:
        'https://res.cloudinary.com/dcbryptkx/image/upload/v1723168085/cp-indoteknik-v3/productsWiper/rear_bosch-removebg-preview_sgnqbl.png', // Replace with actual image URL
};
